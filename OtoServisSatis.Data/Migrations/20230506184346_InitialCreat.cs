        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServsdenCikisTarihi = table.Column<DateTime>(type: "datetime2", nullable: false),
                    YapilanIslemler = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GaranriKapsamindami = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    KasaTipi = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Adres = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2023, 5, 6, 21, 43, 45, 896, DateTimeKind.Local).AddTicks(2540), "admin@gmail.com", "Admin", 1, "123", "Admin", "5554443322" });
